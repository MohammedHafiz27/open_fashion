  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        const CustomPlaceOrderButton(suffix: null, title: "Add Shipping Adress", icon: Icons.add),
        ...
        const CustomPlaceOrderButton(suffix: null, title: "select payment method", icon: Icons.keyboard_arrow_down),
      ],
    );
  }
}
